    ...
    puts h3.equal?(h2)
     ...
     puts "1" <=> 5 # trả về nil nếu kiểu dữ liệu chúng khác nhau
       ...
       e = Exception.new("not really an exception")
        msg = "Error :" + e.to_s # biến đổi exception về dạng string
       ...
       g="ice"
       puts g.freeze  # đóng băng chuỗi g sau khi đóng băng ko làm được gì hết
       puts g.frozen? #nếu chuỗi g bị đóng băng trả về true ngc lại trả về false
       ...
       puts g1
       puts g4
          # sự khác nhau giữa upcase và upcase! là upcase trả về một bản sao mới của chuỗi với tất cả các ký tự được chuyển đổi thành chữ in hoa.
          # upcase! cũng chuyển đổi tất cả các ký tự thành chữ in hoa, nhưng nó thực hiện trực tiếp trên chuỗi gốc
       g2 ="flow"
       g3 = g2.upcase!
       puts g2
       puts g3
        ...
        a7= 0.0 if true # là true  thì a7 được phép hoạt động false a7 ko được hoạt động
        a6 = 0.3 if false # trả về  nil
        print a6
        print "\n"
        print a7
        print "\n"
